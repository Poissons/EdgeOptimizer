...
from deploy2 import deploy_with_node, delete
from check_pod2 import (check_pod, get_resource_dataframe)
...
async def local_run(req: ReqData, local_offload_epoch_returned_by_func: int, pod_list: list,
    ...
    try:
        ...
        if offload_algorithm_index == 1 or offload_algorithm_index == 3:
            ...
            # 因为是模拟
            trans_latency_matrix = {0: 100 + random.random() * 0.01, 1: 20 + random.random() * 0.01, 2: 0}
