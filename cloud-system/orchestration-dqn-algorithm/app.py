...
# curl http://localhost:4002/predict -X POST -d 'observation=["master", 10, {"master": {"3": {"success": 0, "failure": 4}, "13": {"success": 0, "failure": 1}, "8": {"success": 0, "failure": 1}, "17": {"success": 0, "failure": 1}, "1": {"success": 0, "failure": 1}, "15": {"success": 0, "failure": 2}, "9": {"success": 0, "failure": 1}}}, {"master": {"node2": {"15": 1, "19": 1}, "node3": {"16": 1, "18": 1}, "node1": {"17": 1, "20": 1}}}, {}, {"master": {"node1": {"cpu": {"percent": "2", "number": "100m"}, "memory": {"percent": "95", "number": "4146Mi"}, "storage": {"percent": "6", "number": "8Gi"}}, "node2": {"cpu": {"percent": "2", "number": "100m"}, "memory": {"percent": "95", "number": "4146Mi"}, "storage": {"percent": "6", "number": "8Gi"}}, "node3": {"cpu": {"percent": "2", "number": "100m"}, "memory": {"percent": "95", "number": "4146Mi"}, "storage": {"percent": "6", "number": "8Gi"}}}}, 0]'
...
def q_learning_placement(master_name, update_interval, tasks_execute_situation_on_each_node_dict,
    ...
    if master_name in stuck_tasks_situation_on_each_node_dict:
